...
% COPY OF SRTM Wizard Code... Implemented for the Logan Reference Model,
...
function varargout = logan_wizard_gui(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @logan_wizard_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @logan_wizard_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function logan_wizard_gui_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = logan_wizard_gui_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global k2_prime_fixed
k2_prime_fixed = str2num(get(handles.k2_prime,'String'));
...
if strcmp(input,'Choose an Input Method')
    warndlg('Select and Input Method. logan_wizard_gui', 'No Input Method Selected');
else
...
if strncmp(region,'Select',6)
    warndlg('Please select a Brain Region: logan_wizard_gui:update_plot','No Brain Region Selected');
    return;
end
...
% --- Executes during object creation, after setting all properties.
function k2_prime_CreateFcn(hObject, eventdata, handles)
% hObject    handle to kr_rime (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k2_prime_Callback(hObject, eventdata, handles)
% hObject    handle to k2_prime (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k2_prime as text
%        str2double(get(hObject,'String')) returns contents of k2_prime as a double
